    ...
    return (
        <>
            ...
            <main>
                <section>
                    <h2>¡Bienvenidos!</h2>
                    <p>Club de Promos es el lugar donde encontrás las mejores promociones en un solo sitio. Descubrí ofertas en gastronomía, supermercados, farmacias y mucho más, y empezá a ahorrar de forma simple y rápida.</p>
